...
public class SampleCondition implements Condition {
    ...
    public SampleCondition() {
      ...
      *
      * @param property name
      * @param locale for which the property name must be customized
     ...
     *                   define value for the key USER_NAME_LENGTH.
     *                   The value should be a Set with only one element.
     *                   The element should be a String that can be parsed
     *                   as an integer. Please note that properties is not
     *                   cloned by the method.
     *
     * @throws PolicyException if properties is null
     *                         or does not contain a value
     *                         for the key USER_NAME_LENGTH
     *                         or the value of the key
     *                         is not a Set with one String element
